<div class="container">
  <?php if(isset($_GET['message'])) { ?> 
    ...
    <?php } ?>
  <div class="container">
    <form action="index.php?action=password_update" method="POST">
      ...
      <div class="form-group">
        ...
        <input type="password" name="currentPassword" class="form-control" id="exampleInputPassword1" placeholder="Password">
      </div>
      <div class="form-group">
      ...
      <a href="index.php?action=user_edit" class="btn btn-primary" >Go back</a> 
